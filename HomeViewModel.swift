...
let backgroundImageArray: [UIImage] = [#imageLiteral(resourceName: "BK-bea-4"),
                                       ...
                                       #imageLiteral(resourceName: "BK-Sword of Orion"),#imageLiteral(resourceName: "BK-bea"),#imageLiteral(resourceName: "BK-bea-1"),#imageLiteral(resourceName: "BK-bea-2"),#imageLiteral(resourceName: "BK-bea-3"),#imageLiteral(resourceName: "BK-beach sunrise"),#imageLiteral(resourceName: "BK-bea-5"),#imageLiteral(resourceName: "BK-bea-6"),#imageLiteral(resourceName: "BK-bea-7"),#imageLiteral(resourceName: "BK-bea-8")]
